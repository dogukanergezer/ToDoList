    ...
    public class TasksController : Controller
    {
        ...
        public async Task<IActionResult> Edit(TaskItem model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    //await _emailService.SendEmailAsync("dogukanergezer@gmail.com", "dogukanergezer1997@gmail.com", "Task Was Completed", $"Task {editModel.Id} Was Completed on {DateTime.Now}");
                }
                _db.SaveChanges();
                return RedirectToAction("Index");
            }
